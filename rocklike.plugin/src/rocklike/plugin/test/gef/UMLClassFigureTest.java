package rocklike.plugin.test.gef;
...
public class UMLClassFigureTest {
	public static void main(String args[]) {
		...
		Label classLabel1 = new Label("Table", new Image(d, UMLClassFigureTest.class.getResourceAsStream("1.gif")));
		classLabel1.setFont(classFont);

		Label classLabel2 = new Label("Column", new Image(d,
		        UMLClassFigureTest.class.getResourceAsStream("2.gif")));
		...
		Label attribute1 = new Label("columns: Column[]", new Image(d,
		        UMLClassFigure.class.getResourceAsStream("3.gif")));
		...
		Label method1 = new Label("getColumns(): Column[]", new Image(d,
		        UMLClassFigure.class.getResourceAsStream("4.gif")));
